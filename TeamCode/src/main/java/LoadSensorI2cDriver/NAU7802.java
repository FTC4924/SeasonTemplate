...
import static LoadSensorI2cDriver.Constants.ADDRESS_I2C_DEFAULT;
import static LoadSensorI2cDriver.Constants.CTRL2_BITS.CTRL2_CALS;
import static LoadSensorI2cDriver.Constants.CTRL2_BITS.CTRL2_CAL_ERROR;
import static LoadSensorI2cDriver.Constants.DEFAULT_CALIBRATION_FACTOR;
import static LoadSensorI2cDriver.Constants.DEFAULT_SAMPLE_RATE;
import static LoadSensorI2cDriver.Constants.DEFAULT_ZERO_OFFSET;
import static LoadSensorI2cDriver.Constants.GAIN_VALUES.GAIN_128;
import static LoadSensorI2cDriver.Constants.LDO_VALUES.LDO_3V3;
import static LoadSensorI2cDriver.Constants.PGA_PWR_Bits.PGA_PWR_PGA_CAP_EN;
import static LoadSensorI2cDriver.Constants.PU_CTRL_Bits.PU_CTRL_AVDDS;
import static LoadSensorI2cDriver.Constants.PU_CTRL_Bits.PU_CTRL_CR;
import static LoadSensorI2cDriver.Constants.PU_CTRL_Bits.PU_CTRL_PUA;
import static LoadSensorI2cDriver.Constants.PU_CTRL_Bits.PU_CTRL_PUD;
import static LoadSensorI2cDriver.Constants.PU_CTRL_Bits.PU_CTRL_PUR;
import static LoadSensorI2cDriver.Constants.PU_CTRL_Bits.PU_CTRL_RR;
import static LoadSensorI2cDriver.Constants.Register;
import static LoadSensorI2cDriver.Constants.Register.ADC;
import static LoadSensorI2cDriver.Constants.Register.ADCO_B2;
import static LoadSensorI2cDriver.Constants.Register.CTRL1;
import static LoadSensorI2cDriver.Constants.Register.CTRL2;
import static LoadSensorI2cDriver.Constants.Register.PGA_PWR;
import static LoadSensorI2cDriver.Constants.Register.PU_CTRL;
import static LoadSensorI2cDriver.Constants.SAMPLE_SIZE;
import static LoadSensorI2cDriver.Constants.SPS_VALUES.SPS_80;
